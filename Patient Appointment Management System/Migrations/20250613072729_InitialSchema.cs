        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookedAvailabilitySlotId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Appointments", x => x.AppointmentId);
                    table.ForeignKey(
                        name: "FK_Appointments_AvailabilitySlots_BookedAvailabilitySlotId",
                        column: x => x.BookedAvailabilitySlotId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_BookedAvailabilitySlotId",
                table: "Appointments",
                column: "BookedAvailabilitySlotId",
                unique: true,
                filter: "[BookedAvailabilitySlotId] IS NOT NULL");
